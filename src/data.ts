...
export const PASSIVES: Passive[] = [
  ...
  },
  {
    ...
    name: '天魔解体',
    mark: '魔',
    desc: '每重施法间隔 -8%；半血以下额外 -2%、移速 +4%；代价：气血上限 -2%',
    color: '#d698bc',
    school: 'demonic',
  },
  {
    ...
    name: '九幽冥典',
    mark: '幽',
    desc: '每重法术范围 +16%，命中减速 0.15 秒；代价：最终伤害 -2%',
    color: '#bca6de',
    school: 'demonic',
  },
  {
    ...
    name: '白骨魔功',
    mark: '骨',
    desc: '每重气血上限 +18%，骨刺反击基础伤害为最大气血的 12%；代价：移动速度 -1%',
    color: '#dbcfb9',
    school: 'demonic',
  },
  {
    ...
    name: '噬魂大法',
    mark: '噬',
    desc: '每重斩妖回复 0.18 + 最大气血的 0.02%，持续时间 +20%；代价：自然恢复 -4%',
    color: '#c29bd9',
    school: 'demonic',
  },
  {
    ...
    name: '厄运咒',
    mark: '咒',
    desc: '每重暴击率 +8%，暴击伤害倍率 +0.12；代价：承受伤害 +1.5%',
    color: '#dca3b4',
    school: 'demonic',
  },
  {
    ...
    name: '拘魂秘术',
    mark: '魂',
    desc: '每重灵气收益 +10%；首重拘取周围 160 像素内斩妖灵气，之后每重 +50 像素；代价：施法间隔 +1%',
    color: '#aaaedc',
    school: 'demonic',
  },
  {
    ...
    name: '逆命魔典',
    mark: '逆',
    desc: '每重灵气收益 +18%，法宝伤害 +8%；代价：承受伤害 +1.5%',
    color: '#d7a2b6',
    school: 'demonic',
  },
];
